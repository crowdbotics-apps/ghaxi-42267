"""
Django settings for ghaxi_42267 project.
...
WSGI_APPLICATION = 'ghaxi_42267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ghaxi_42267 API",
    "DESCRIPTION": "API documentation for ghaxi_42267 App",
    "VERSION": "v1",
}
